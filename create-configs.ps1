#!/usr/bin/pwsh
    ...
    New-Item -Path $ScriptWorkingPath -Name $RemoteHostConfigName -ItemType "file" -Value "# This is file was generated by $CurrentUser on (Get-Date -Format MM/dd/yyyy HH:mm)"
